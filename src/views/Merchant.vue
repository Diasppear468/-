    ...
    <div class="activity">
      ...
      <div class="activity-list">
        <p v-for="(v,i) in data.supports" :key="i" class="act-act">
          <span>
            <img src="../assets/imgs/zhe.png" v-show="v.type==0" />
            <img src="../assets/imgs/jian.png" v-show="v.type==1" />
            <img src="../assets/imgs/piao.png" v-show="v.type==2" />
            <img src="../assets/imgs/bao.png" v-show="v.type==3" />
          </span>
          {{v.description}}
        </p>
      </div>
